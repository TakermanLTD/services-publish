    ...
    <div class="accordion" id="accordionPublications">
        <div class="accordion-item">
            <h2 class="accordion-header" id="accordeonPublications">
                <button class="accordion-button text-center collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePublications" aria-expanded="false" aria-controls="collapsePublications">
                    Project Platforms
                </button>
            </h2>
            <div id="collapsePublications" class="accordion-collapse collapse" aria-labelledby="accordeonPublications" data-bs-parent="#accordionPublications">
